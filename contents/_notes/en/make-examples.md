...
# Makefile used with an AVR project

As a pedagogic to undestan how to compile and Use AVR microcontrollers 100% with a GNU/Linux envrionment I did this demo: [AVR RGB LED Control](https://github.com/razielgdn/AVR_RGB_LED_Control/tree/main){:target="_blank"}.

Also I did and article to explain how to use them with VSCode and linux tools: [Build and flash AVR projects in  Linux](https://razielgdn.github.io/risingembeddedmx/projects/en/2-avr-section/build-and-flash){:target="_blank"}

Well to create this makefile I took has a model the Microchip Studio autogenerated makefile.
And adapted it to my small project.
...
```
Well researching to write this article I understand better the functionality of the makefiles and with the Help of an AI chatbot I improve these makefile.
...
.PHONY: all clean distclean flash verify fuses-read fuses-write fuse-lfuse
.PHONY: size info help debug
